...
export const GET_NEWSLIST_KAIYAO = 'GET_NEWSLIST_KAIYAO';

export const GET_NEWSLIST_B1 = 'GET_NEWSLIST_B1';
...
export const ISNEWESTCONTLOADED = 'ISNEWESTCONTLOADED';

export const HASPARAGRAPH = 'HASPARAGRAPH';
